  ...
  return (
    ...
    >
      ...
      <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4">
        Projetos{' '}
        <span className="text-blue-600 dark:text-blue-400">Recentes</span>
      </h2>
      <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
        Uma seleção dos meus projetos mais recentes, desde aplicações web
        completas até trabalhos em andamento.
      </p>
    </motion.div>
  );
}
